...
const pages: SidebarItem[] = [
  ...
  { href: "/panel/mailing/inbox", icon: HiInboxIn, label: "Inbox", badge: "3" },
  {
    ...
    label: "Locations",
    items: [
      { href: "/panel/locations/moldova", label: "Moldova" },
  ...
  },
  {
    ...
    label: "Users",
    items: [
      { href: "/panel/users", label: "Users list" },
  ...
  },
  {
    ...
    label: "Pages",
    items: [
      { href: "/panel/pages/home", label: "Home Page" },
      { href: "/panel/pages/contacts", label: "Contact Page" },
      { href: "/panel/pages/services", label: "Services Page" },
