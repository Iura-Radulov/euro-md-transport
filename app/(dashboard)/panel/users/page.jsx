...
export default function Page(){
    ...
    async function handleDelete(itemId) {
            try {
                await fetch(`/api/users/${itemId.toString()}`, {
                    method: "DELETE",
                });
                const filteredPosts = users.filter(item=>item._id !==itemId)
                ...
                <div className="mb-1 w-full">
                    <div className="mb-4">
                        <Breadcrumb className="mb-5">
                            <BreadcrumbItem href="/panel">
                                <div className="flex items-center gap-x-3">
                                    <HiHome className="text-xl" />
                                    <span className="dark:text-white">Home</span>
                                </div>
                            </BreadcrumbItem>
                            <BreadcrumbItem href="/panel/users/list">Users</BreadcrumbItem>
                    ...
                    <div className="inline-block min-w-full align-middle">
                        <div className="overflow-hidden shadow">
                            {isLoading ?
                                ...
                                :  <AllUsersTable usersList={users} />}

                        </div>
                    </div>
                </div>
            </div>
            <Pagination usersList={users} />
        </>
        )


    function AllUsersTable({ usersList }) {
        return (
                        ...
                        >
                            ...
                            <TableCell className="ml-auto rounded-none!">
                                <div className=" flex items-center justify-end gap-x-3 whitespace-nowrap">
                                    <EditUserModal userId={user._id}  setUsers={setUsers} />
                                    <DeleteModal  itemId={user._id} handleDelete={handleDelete} />
                                </div>
                            </TableCell>
                        </TableRow>
                    ))}
