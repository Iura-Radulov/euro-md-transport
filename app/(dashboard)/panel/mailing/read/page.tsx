  ...
  return (
    <div className="block items-center justify-between border-b border-gray-200 bg-white p-4 sm:flex dark:border-gray-700 dark:bg-gray-800">
      <div className="flex items-center divide-x divide-gray-100 dark:divide-gray-700">
        <div className="pr-3">
          <Link
            href="/panel/panel/mailing/inbox"
...
function Footer() {
  return (
    <div className="right-0 bottom-0 w-full border-t border-gray-200 bg-white p-4 lg:fixed lg:pl-64 dark:border-gray-700 dark:bg-gray-800">
      <div className="items-center sm:flex sm:divide-x sm:divide-gray-100 lg:pl-4 dark:divide-gray-700">
        <div className="mb-3 space-y-3 sm:mr-3 sm:mb-0 sm:flex sm:space-y-0 sm:space-x-3">
          <Button color="blue" href="/panel/mailing/reply">
